                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            },
                            {
                                ...
                                href: item.href,
                                className: "block px-4 py-3 rounded-xl transition-all duration-300 font-medium hover-scale ".concat(pathname === item.href ? 'text-gray-100 bg-black/10 shadow-lg' : 'text-gray-300 hover:text-gray-100 hover:bg-black/5'),
...
"[project]/src/utils/imageStorage.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class ImageStorage {
   ...
   */ async uploadImage(file, path) {
        try {
            ...
            const fileName = path || "".concat(Date.now(), "-").concat(Math.random().toString(36).substring(2), ".").concat(fileExt);
            // رفع الملف
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from(this.bucketName).upload(fileName, file, {
                cacheControl: '3600',
                upsert: false
            });
            if (error) {
                ...
                if (error.message) {
                    if (error.message.includes('not found')) {
                        ...
                        errorMessage = "خطأ في الرفع: ".concat(error.message);
                    }
                }
                return {
                    success: false,
            ...
            const { data: { publicUrl } } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from(this.bucketName).getPublicUrl(data.path);
            return {
                success: true,
                url: publicUrl
            };
   ...
   */ async deleteImage(path) {
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from(this.bucketName).remove([
                path
            ]);
            if (error) {
   ...
   */ async listImages() {
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from(this.bucketName).list();
            if (error) {
                console.error('List error:', error);
                return [];
            }
            return (data === null || data === void 0 ? void 0 : data.map((file)=>file.name)) || [];
        } catch (error) {
            console.error('List error:', error);
            return [];
        }
    ...
    constructor(){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "bucketName", 'portfolio-images');
    }
}
class FileStorage {
    /**
   ...
   */ async uploadFile(file, fileName, options) {
        try {
            let fileData;
            let contentType = (options === null || options === void 0 ? void 0 : options.contentType) || 'text/plain';
            ...
            if (fileData.size > 10 * 1024 * 1024) {
                return {
                    success: false,
                    error: 'حجم الملف يجب أن يكون أقل من 10MB'
                };
            }
            // رفع الملف
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from(this.bucketName).upload(fileName, fileData, {
                contentType,
                upsert: true
            });
            if (error) {
                ...
                if (error.message.includes('not found')) {
                    errorMessage = 'Bucket "'.concat(this.bucketName, '" غير موجود. يرجى إنشاؤه أولاً');
                } else if (error.message.includes('Unauthorized')) {
                    errorMessage = 'غير مصرح لك بالرفع. تحقق من الصلاحيات';
                } else {
                    errorMessage = "خطأ في الرفع: ".concat(error.message);
            ...
            // الحصول على الرابط
            let fileUrl;
            if (options === null || options === void 0 ? void 0 : options.makePublic) {
                const { data: { publicUrl } } = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from(this.bucketName).getPublicUrl(data.path);
                fileUrl = publicUrl;
            } else {
    ...
    /**
   * رفع ملف .env
   */ async uploadEnvFile(envContent) {
        const fileName = "env-".concat(Date.now(), ".local");
   ...
   */ async downloadFile(fileName) {
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].storage.from(this.bucketName).download(fileName);
            if (error) {
                console.error('Download error:', error);
                return {
                    success: false,
                    error: "خطأ في تحميل الملف: ".concat(error.message)
                };
            }
   ...
   */ async listFiles() {
    ...
    constructor(){
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_define_property$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(this, "bucketName", 'env-files');
    }
}
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$imageStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/imageStorage.ts [app-client] (ecmascript)");
...
function ImageUpload(param) {
    let { onUploadSuccess, onUploadError, className = '', maxSize = 5 * 1024 * 1024, acceptedTypes = [
        'image/jpeg',
        'image/png',
        'image/webp',
        'image/gif'
    ...
    const handleFileUpload = async (file)=>{
        ...
        if (file.size > maxSize) {
            const error = "حجم الملف كبير جداً. الحد الأقصى ".concat(Math.round(maxSize / 1024 / 1024), "MB");
            setUploadResult({
                success: false,
                error
            });
        ...
        reader.onload = (e)=>{
            var _e_target;
            setPreview((_e_target = e.target) === null || _e_target === void 0 ? void 0 : _e_target.result);
        };
        reader.readAsDataURL(file);
        // رفع الملف
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$imageStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["imageStorage"].uploadImage(file);
        setIsUploading(false);
        setUploadResult(result);
        if (result.success && result.url) {
            onUploadSuccess === null || onUploadSuccess === void 0 ? void 0 : onUploadSuccess(result.url);
        } else {
            const errorMsg = result.error || 'فشل في رفع الصورة';
            console.error('Upload error details:', errorMsg);
            onUploadError === null || onUploadError === void 0 ? void 0 : onUploadError(errorMsg);
        }
    };
    const clearUpload = ()=>{
        setUploadResult(null);
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "relative border-2 border-dashed rounded-2xl p-8 text-center transition-all duration-300 cursor-pointer\n          ".concat(isDragging ? 'border-red-400 bg-red-500/10 scale-105' : 'border-gray-600 hover:border-red-400 hover:bg-black/5', "\n          ").concat(isUploading ? 'pointer-events-none opacity-50' : '', "\n        "),
                onDragOver: handleDragOver,
                onDragLeave: handleDragLeave,
                onDrop: handleDrop,
                onClick: ()=>{
                    var _fileInputRef_current;
                    return !isUploading && ((_fileInputRef_current = fileInputRef.current) === null || _fileInputRef_current === void 0 ? void 0 : _fileInputRef_current.click());
                },
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                        ref: fileInputRef,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: isUploading ? 'جاري رفع الصورة...' : 'اسحب وأفلت الصورة هنا'
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/ImageUpload.tsx",
                                        lineNumber: 153,
                                        columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "أو انقر لاختيار صورة من جهازك"
                                    }, void 0, false, {
                                        fileName: "[project]/src/components/ImageUpload.tsx",
                                        lineNumber: 156,
                                        columnNumber: 15
                    ...
                    isUploading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "animate-spin rounded-full h-8 w-8 border-b-2 border-red-400"
                        }, void 0, false, {
                            fileName: "[project]/src/components/ImageUpload.tsx",
                            lineNumber: 168,
                            columnNumber: 13
            ...
            uploadResult && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                className: "mt-4 p-4 rounded-xl flex items-center space-x-3 ".concat(uploadResult.success ? 'bg-green-500/10 border border-green-500/20' : 'bg-red-500/10 border border-red-500/20'),
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-sm font-medium ".concat(uploadResult.success ? 'text-green-400' : 'text-red-400'),
                                children: uploadResult.success ? 'تم رفع الصورة بنجاح!' : 'فشل في رفع الصورة'
                            }, void 0, false, {
                                fileName: "[project]/src/components/ImageUpload.tsx",
                                lineNumber: 186,
                                columnNumber: 13
                            }, this),
                            uploadResult.url && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-xs text-gray-400 mt-1 break-all",
                            ...
                            uploadResult.error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                className: "text-xs text-red-300 mt-1",
                                children: uploadResult.error
                            }, void 0, false, {
                                fileName: "[project]/src/components/ImageUpload.tsx",
                                lineNumber: 197,
                                columnNumber: 15
                    ...
                    uploadResult.success && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
...
_s(ImageUpload, "/nRFuJ0xf2AzFbH0EVttiFQGauU=");
_c = ImageUpload;
var _c;
...
function Admin() {
    ...
    const fetchProjects = async ()=>{
        try {
            const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('projects').select('*').order('created_at', {
                ascending: false
            });
    ...
    const fetchFiles = async ()=>{
        try {
            const fileList = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$imageStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fileStorage"].listFiles();
            setFiles(fileList);
        } catch (error) {
    ...
    const handleFileUpload = async (file)=>{
        ...
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$imageStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fileStorage"].uploadFile(file, file.name);
            if (result.success) {
                setUploadStatus('تم رفع الملف بنجاح!');
                fetchFiles(); // تحديث القائمة
            } else {
                setUploadStatus("فشل في الرفع: ".concat(result.error));
            }
        } catch (error) {
    ...
    const handleEnvUpload = async ()=>{
        const envContent = "NEXT_PUBLIC_SUPABASE_URL=".concat(("TURBOPACK compile-time value", "https://lokpkqfafuumhgqfqaln.supabase.co"), "\nNEXT_PUBLIC_SUPABASE_ANON_KEY=").concat(("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imxva3BrcWZhZnV1bWhncWZxYWxuIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTY0MTEyODUsImV4cCI6MjA3MTk4NzI4NX0.ZYvc-k85wws5qBobg5FUszFxWX8-spohrtehkZeDDgk"));
        setUploadStatus('جاري رفع ملف .env...');
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$imageStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fileStorage"].uploadEnvFile(envContent);
            if (result.success) {
    ...
    const handleFileDownload = async (fileName)=>{
        try {
            const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$imageStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fileStorage"].downloadFile(fileName);
            if (result.success) {
                setFileContent(result.content || '');
                setSelectedFile(fileName);
            } else {
                alert("فشل في تحميل الملف: ".concat(result.error));
            }
        } catch (error) {
            console.error('Download error:', error);
    ...
    const handleFileDelete = async (fileName)=>{
        if (!confirm('هل أنت متأكد من حذف الملف "'.concat(fileName, '"؟'))) return;
        try {
            const success = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$imageStorage$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fileStorage"].deleteFile(fileName);
            if (success) {
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            if (editingProject) {
                const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('projects').update(projectData).eq('id', editingProject.id);
                if (error) throw error;
            } else {
                const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('projects').insert([
                    projectData
                ]);
                if (error) throw error;
            }
    ...
    const handleDelete = async (id)=>{
        ...
        try {
            const { error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('projects').delete().eq('id', id);
            if (error) throw error;
            fetchProjects();
        } catch (error) {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                                        ...
                                        children: "Admin Dashboard - Project Management"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/admin/page.tsx",
                                        lineNumber: 235,
                                        columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: "Add, update, and delete your projects from here"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/admin/page.tsx",
                                        lineNumber: 238,
                                        columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 mb-12 border border-gray-700/50 scroll-fade-in-up stagger-3",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                        className: "text-2xl font-bold text-gray-100 mb-6",
                                        children: editingProject ? 'Update Project' : 'Add New Project'
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/admin/page.tsx",
                                        lineNumber: 245,
                                        columnNumber: 15
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        ...
                                                        children: loading ? 'Saving...' : editingProject ? 'Update' : 'Add'
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/admin/page.tsx",
                                                        lineNumber: 349,
                                                        columnNumber: 19
                                                    }, this),
                                                    editingProject && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        type: "button",
                                                        onClick: resetForm,
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50 scroll-fade-in-up stagger-4",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                        className: "text-2xl font-bold text-gray-100 mb-6",
                                    ...
                                    loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: projects.map((project)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    project.technologies.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "bg-gray-800/80 backdrop-blur-sm rounded-2xl p-8 mb-12 border border-gray-700/50 scroll-fade-in-up stagger-5",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                        className: "text-2xl font-bold text-gray-100 mb-6",
                                        children: "إدارة الملفات في Supabase Storage"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/admin/page.tsx",
                                        lineNumber: 433,
                                        columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            uploadStatus && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "p-4 rounded-lg mb-4 ".concat(uploadStatus.includes('نجاح') ? 'bg-green-600/20 border border-green-600/30' : uploadStatus.includes('فشل') ? 'bg-red-600/20 border border-red-600/30' : 'bg-blue-600/20 border border-blue-600/30'),
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    ...
                                                    files.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        className: "space-y-2",
                                                        children: files.map((fileName)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                                        className: "text-lg font-semibold text-gray-100 mb-4",
                                                        children: selectedFile ? "محتوى الملف: ".concat(selectedFile) : 'اختر ملف لعرض محتواه'
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/admin/page.tsx",
                                                        lineNumber: 511,
                                                        columnNumber: 19
                                                    ...
                                                    fileContent ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("pre", {
                                                            className: "text-gray-100 text-sm whitespace-pre-wrap overflow-x-auto",
                                                        ...
                                                        className: "text-gray-400",
                                                        children: 'انقر على "عرض" لرؤية محتوى الملف'
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/admin/page.tsx",
                                                        lineNumber: 521,
                                                        columnNumber: 21
...
_s(Admin, "fIYTrKHn3rxsCCc5IiUpaS3ijOs=", false, function() {
    return [
...
//# sourceMappingURL=src_2415a511._.js.map